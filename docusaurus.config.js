    ...
    [
      ...
      "@docusaurus/plugin-client-redirects",
      {
        redirects: [
          ...
          { to: "/discover/tokenomics", from: ["/tokenomics", "/investors/tokenomics"] },
          { to: "/discover/roadmap", from: ["/roadmap", "/investors/roadmap"] },
          { to: "/discover/acurast-token", from: ["/acurast-token", "/investors/acurast-token"] },
          { to: "/discover/acurast-token", from: "/token" },
          { to: "/discover/metrics", from: "/investors/metrics" },
          { to: "/discover", from: "/investors" },
