...
Acurast has already onboarded 70,000+ compute units worldwide on its incentivized testnet making it the most decentralized verifiable compute network available today. This impressive amount of compute already powers mission critical workloads with high-security and AI requirements.
...
Over 74,000 phones as compute units stretch across the globe without relying on centralized data centers, united by a community of more than 18,000 “Cloud Rebels.” Active in over 130 countries, this network sets a new standard for true decentralization.
