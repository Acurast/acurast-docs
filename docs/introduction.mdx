...
Acurast has already onboarded 227'181 compute units worldwide on its incentivized testnet making it the most decentralized verifiable compute network available today. This impressive amount of compute already powers mission critical workloads with high-security and AI requirements.
...
<div class="row margin-vert--md">
  <div class="col col--6 margin-vert--sm">
    <a class="card padding--md" href="/developers" style={{ display: 'block', height: '100%' }}>
      <h4>🛠️ Build on Acurast →</h4>
      <p>Deploy apps to a global phone-powered compute network. CLI, SDK, examples.</p>
    </a>
  </div>
  <div class="col col--6 margin-vert--sm">
    <a class="card padding--md" href="/processors" style={{ display: 'block', height: '100%' }}>
      <h4>📱 Provide Compute →</h4>
      <p>Run a phone, earn rewards. Hardware list, install guide, payouts.</p>
    </a>
  </div>
  <div class="col col--6 margin-vert--sm">
    <a class="card padding--md" href="/token-holders" style={{ display: 'block', height: '100%' }}>
      <h4>🪙 Hold ACU →</h4>
      <p>Claim vested tokens, stake on providers, vote in governance.</p>
    </a>
  </div>
  <div class="col col--6 margin-vert--sm">
    <a class="card padding--md" href="/investors" style={{ display: 'block', height: '100%' }}>
      <h4>📊 Discover Acurast →</h4>
      <p>Tokenomics, audits, traction, roadmap, whitepapers.</p>
    </a>
  </div>
</div>
