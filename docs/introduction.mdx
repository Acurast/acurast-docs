...
Anything that runs in a Node.js environment: web servers, API integrations, scheduled jobs, Telegram bots, headless browsers (Puppeteer), WebAssembly modules, and LLM inference. See [Example Apps](/developers/examples) for ready-to-clone projects, or jump to the [Quickstart](/developers/getting-started/quickstart).
