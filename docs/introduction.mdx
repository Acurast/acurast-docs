...
description: Acurast is the decentralized serverless Cloud based on mobile phones.
slug: /
hide_title: true
---
...
Acurast is a decentralized serverless cloud that addresses all these shortcomings, following the call for a global-scale cloud founded on the principles of the open-source movement.
