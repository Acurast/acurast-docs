...
### **WebView**
_Added in: <<TODO: add version, when released>> (Android)_
...
/**
 * Closes all open WebView tabs.
 * @param {WebViewCloseSuccess} onSuccess the success callback.
 * @param {WebViewError} onError the error callback.
 */
 ...
 */
type WebViewTabClose = () => Promise<void>;
 ...
 * @param {number|undefined} interval the interval of consecutive refreshes in milliseconds. If not provided, the default interval of 500 milliseconds is used.
 */
type WebViewStartRefreshLoop = (interval) => void;

/**
 * @function WebViewStopRefreshLoop
 * Stops the ongoing refresh loop for the WebView tab.
 */
type WebViewStopRefreshLoop = () => void;
```
