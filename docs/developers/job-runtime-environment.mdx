...
```javascript
/**
 * @return {JobId} Object representing a job id. 
 * 
 * Example:
 * {
 *  origin: {
...
type JobId = { origin: { kind: string, source: string }, id: string };

/**
 * @return {number} The slot number of this job.
 */
_STD_.job.getSlot();

/**
 * @return {PublicKeys} Object containing the job specific public keys.
 *
 * Example:
 * {
...
```javascript
/**
 * Signs the given payload with the secp256r1 key generated for the current job.
 *
 * @since 1.9.2 (version code 58)
 *
...
/**
 * Encrypts the given payload with the secp256r1 key generated for the current job.
 *
 * @since 1.9.2 (version code 58)
 *
...
/**
 * Decrypts the given payload with the secp256r1 key generated for the current job.
 *
 * @since 1.9.2 (version code 58)
 *
...
/**
 * Signs the given payload with the secp256k1 key generated for the current job.
 *
 * @since 1.9.2 (version code 58)
 *
 * @param {string} payload Hex string representing the bytes to sign.
...
/**
 * Encrypts the given payload with the secp256k1 key generated for the current job.
 *
 * @since 1.9.2 (version code 58)
 *
 * @param {string} payload Hex string representing the bytes to encrypt.
...
/**
 * Decrypts the given payload with the secp256k1 key generated for the current job.
 *
 * @since 1.9.2 (version code 58)
 *
 * @param {string} payload Hex string representing the bytes to decrypt.
...
/**
 * Signs the given payload with the ed25519 key generated for the current job.
 *
 * @since 1.9.2 (version code 58)
 *
 * @param {string} payload Hex string representing the bytes to sign.
...
/**
 * Encrypts the given payload with the ed25519 key generated for the current job.
 *
 * @since 1.9.2 (version code 58)
 *
 * @param {string} payload Hex string representing the bytes to encrypt.
...
/**
 * Decrypts the given payload with the ed25519 key generated for the current job.
 *
 * @since 1.9.2 (version code 58)
 *
 * @param {string} payload Hex string representing the bytes to decrypt.
...
/**
 * @return {string} The processor's ethereum address for the current job.
 */
