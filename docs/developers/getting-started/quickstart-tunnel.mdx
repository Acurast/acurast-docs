...
For an end-to-end reference with multi-processor leader election and certificate persistence, see **[acurast-tunnel-scripts ↗](https://github.com/Acurast/acurast-tunnel-scripts)**.
