---
title: Quickstart - Tunnel (Canary Preview)
...
Tunnel deployments require cACU to cover execution costs. On **Canary**, claim free cACU from the **[faucet ↗](https://faucet.acurast.com)**.
...
<Tabs groupId="tunnel-relays">
  <TabItem value="nodejs" label="Canary" default>
...
The public URL of every deployment is `https://<clientId>.<yourDomainSuffix>:8443`. The wildcard makes any `<clientId>` resolve to the relays:

```
*.tunnel.example.com.   A   57.129.64.128
*.tunnel.example.com.   A   176.9.45.137
