...
Acurast supports Tezos smart contracts as the destination of outputs from Acurast Transmitters directly as the required secp256r1 is supported natively by Tezos.
