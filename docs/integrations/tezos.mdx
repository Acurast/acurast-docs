...
Acurast Processors can directly communicate with Tezos smart contracts as the required secp256r1 is natively available on Tezos.

## Example Contract

The following Tezos smart contract in SmartPy is an example of a contract that receives price points from Acurast Processors.
