...
## Chainlink price feeds deployments

We have deployed a few price oracles that can be used to connect your smart contracts to asset pricing data like the `BTC / USD` feed.

### How to consume the price from the oracle?
