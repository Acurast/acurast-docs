...
4. **Settlement:** Similar to network fees, ACU acts as a unified settlement token to ensure the reputation and quality of the provided compute, with a burn on settlements to prevent reputation tampering.
5. **Governance:** With an on-chain treasury of over 24% allocation, which replenishes itself from part of the inflation. With token holders making the protocol and future development-related decisions.
...
| Listing Incentives _(Community Activation)_ \*                           | 5%     | 50,000,000         | 40%              | 0                                                                        | 24                      |
| Operational Funds                                                        | 11.50% | 115,000,000        | 0%               | 0                                                                        | 24                      |
| Community Treasury                                                       | 24.00% | 240,000,000        | 0%               | 3                                                                        | 24\*\*                  |
| Team and Advisors                                                        | 24.00% | 240,000,000        | 0%               | 6                                                                        | 36                      |
| Liquidity Provision \*\*\*                                               | 10%    | 100,000,000        | 30%              | 0                                                                        | 24                      |
| Early Backers                                                            | 6.50%  | 65,000,000         | 0%               | 0                                                                        | 24                      |
| CoinList Token Launch                                                    | 6.50%  | 65,000,000         | 100%             | 0                                                                        | 0                       |

_\* Potential subject to change_  
_\*\* Governance enablement required_  
_\*\*\* These tokens are exclusively used to foster liquidity long-term and will not be fully deployed at TGE._
