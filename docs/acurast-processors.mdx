...
Become a Processor on Acurast with an Android mobile device that provides computational ressources. Earn rewards from developers that utilize your ressources with the launch of the Acurast Marketplace.
...
1. Go to the [Acurast Console](https://console.acurast.com/) and log in with your [Talisman Wallet](https://www.talisman.xyz/wallet) or your [PolkadotJS Extension](https://polkadot.js.org/extension/) to create an account that manges one or more Processors.
...
1. Device Ready - Awesome, your device is now setup and ready to accept Jobs.
...
Acurast's protocol is setup to be inclusive of various Trusted Execution Environments, the inital focus is on Android powered devices.

## Native Communication

Acurast Processors communicate with the destination, defined by the Consumer, natively. This allows for answer on-chain in time and reduced an unnecessary step of communication that would have to be routed over the Acurast Protocol.
