...
Security is a top priority for the Acurast ecosystem. The Acurast Processor app has undergone professional security auditing to ensure the safety and integrity of the compute infrastructure.

**xcBTC Audit**

A comprehensive penetration test and security audit was performed by [Compass Security ↗](https://www.compass-security.com/) on the Acurast Processor app in the context of [xcBTC.com](https://xcbtc.com/), a Bitcoin bridge built on Acurast. This audit evaluated the security of the Acurast infrastructure, including the TEE (Trusted Execution Environment) implementation, to ensure it meets the high security standards required for handling sensitive operations.

**[Acurast Processor App Security Audit Report (xcBTC.com) ↗](https://github.com/xcbtc-bridge/audits/blob/main/report_89395_Pentest_tzBTC_Android_App_v1.0.pdf)**
