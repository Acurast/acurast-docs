...
- **Bootstrapping _(has been sunset in favor of Benchmarked Rewards)_ **: Earn 250 cACU each month in Bootstrapping Rewards. Run your Processor, connected to the internet, for a month and earn 250 cACU in bootstrapping rewards. You will earn a fraction of the full reward each hour.
