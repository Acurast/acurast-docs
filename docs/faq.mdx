...
Get started as a [Processor](/acurast-processors) on Acurast and provide compute to earn rewards, either as with Lite or Core:
...
- Disconnect and conenct your wallet to the Hub.
- Use another browser.
