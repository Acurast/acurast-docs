...
1. User inititates conversion on Acurast Canary
...
4. On Mainnet the lock can be updated once between 3 to 48 cycles:  
   4.1. Default: Unlocked after 48x cyles at 28 days (3.7 years) = 1 to 1 ratio  
   4.2. Minimum: Unlocked after 3x cycles (2.8 months) = 6.5% ACU  
   4.3. Example: Unlocked after 24x cyles (1.75 years) = 50% ACU
