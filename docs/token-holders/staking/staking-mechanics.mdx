...
slug: /token-holders/staking/staking-mechanics
---
...
<p style={{textAlign: 'center', fontSize: '0.9em', color: '#666', marginTop: '0.5em'}}>Screenshot of the processor app</p>
...
<p style={{textAlign: 'center', fontSize: '0.9em', color: '#666', marginTop: '0.5em'}}>Screenshot of the staking UI</p>
