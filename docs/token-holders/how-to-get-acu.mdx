...
See [Acurast Token](/investors/acurast-token) for the full list of deployed token contracts.
...
Only interact with token contracts listed in the [official token reference](/investors/acurast-token#overview-of-deployed-acu-token-contracts-and-instances). Beware of fake tokens with similar names.
...
- [Acurast Token](/investors/acurast-token) — token contracts and instances.
