...
Consumers can get access to the legacy Web2 world through this module and bring off-chain data of public or permissoned APIs and off-chain computation to their Web3 application in the [supported blockchain ecosystems](/integrations/introduction) .
