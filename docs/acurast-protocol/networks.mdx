---
title: Acurast Networks
slug: /acurast-protocol/acurast-network
---

Acurast will bootstrap three distinct networks: (a) the [Acurast Testnet](#acurast-testnet), (b) the [Acurast Canary](#acurast-canary), and (c) the [Acurast Mainnet](#acurast-mainnet). 
