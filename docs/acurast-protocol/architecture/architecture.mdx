...
### Consensus Layer
The consensus layer is the permissionless foundation of Acurast, where the Orchestrator matches consumer's jobs to processors, as outlined in the End-to-End flow (*c.f.,* [End-to-End Zero Trust Job Execution](/acurast-protocol/architecture/end-to-end) ). The second core part of the consensus layer is the reputation engine (*c.f.,* ), which as sures that the reputation scores of processors are correctly updated and incentivize honest behavior. 
