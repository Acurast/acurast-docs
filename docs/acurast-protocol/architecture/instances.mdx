...
1. **Alpha-Net**
   Launching in Q1 of 2024. The purpose of this phase is to onboard external Collators and enable nominated Proof of Stake for the selection of those Collators.
...
1. **Beta-Net**
   With an ETA of 3 months post-Alpha-Net launch. This phase removes sudo and migrates governance to the active stakers and enables token transfers.
