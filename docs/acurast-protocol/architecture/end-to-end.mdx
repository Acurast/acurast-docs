...
slug: /acurast-protocol/end-to-end
---
...
<ThemedImage
  width="800px"
  sources={{
    light: useBaseUrl("/img/end-to-end-light.svg"),
    dark: useBaseUrl("/img/end-to-end-light.svg"),
  }}
/>
<p style={{color: "gray", fontSize: "small" }}>Figure 1: End-to-End Zero Trust Job Execution </p>
